...
define([], function () {
    ...
    Fx_Commons.prototype.raiseCustomEvent = function (item, type, data) {
        ...
        var self = this;
       // if(data.call != 'MENU INIT_STORAGE')
          //  console.log("************** COMMONS: raiseCustomEvent ************ FROM "+data.call);
        ...
        if (self.isNode(item)) {
          //  if(data.call != 'MENU INIT_STORAGE')
           //  console.log("************** COMMONS: raiseCustomEvent BEFORE DISPATCH ************");
    ...
    //Getter and Setter for session cache
    Fx_Commons.prototype.getCacheModule = function (key) {

        return o.sessionStorage.modules[key];
